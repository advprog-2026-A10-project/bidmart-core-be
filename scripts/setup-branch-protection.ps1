...
function New-MainStagingProtectionPayload {
    return @{
...
function Configure-Repository {
    ...
    Set-BranchProtection -RepoSlug $RepoSlug -BranchName "main" -Payload (New-MainStagingProtectionPayload)
    Set-BranchProtection -RepoSlug $RepoSlug -BranchName "staging" -Payload (New-MainStagingProtectionPayload)
